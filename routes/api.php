...
Route::group(['middleware' => 'auth:sanctum'], function () {
  ...
  # Graphic
  Route::get('/graphic/get-data', [App\Http\Controllers\Api\Graphic\GraphicDataController::class, 'getGraphic'])->name('api.graphic');
  ...
  Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('update/user/action-plan', [App\Http\Controllers\Api\Admin\Users\ClientController::class, 'actionPlan']);
    ...
    Route::post('plan/delete', [App\Http\Controllers\Api\Admin\Plans\PlansController::class, 'deletePlan']);
