...
class CreditResource
{
     ...
     * @return \App\Models\Credit\Credit
     */
    public function create($user_id, int $coin_id, int $plan_id = null, int $type_id = 1, int $status_id = 2, float $amount, float $base_amount, string $description = '', int $order_id = null)
    {
